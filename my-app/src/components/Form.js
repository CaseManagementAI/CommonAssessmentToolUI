...
import { Typography, Grid, TextField, Button, Checkbox, FormControlLabel, Select, MenuItem, FormControl, InputLabel } from '@mui/material';
...
function Form({ onSubmit }){
    ...
    return (
     ...
     <Typography variant="h4" component="h2" gutterBottom className={styles.formTitle}>  
        Candidate Form
        </Typography>
        ...
        <Grid item xs={12} sm={2}>
            <FormControlLabel
            control={<Checkbox checked={formData.ifDisability} onChange={handleChange} name="ifDisability" />}
            label="Disability"
            />
        </Grid>
        ...
        <Grid item xs={12} sm={4}>
            ...
            >
                ...
                <MenuItem value="Family Sponsorship">Family Sponsorship</MenuItem>
                <MenuItem value="Provincial Nominee">Provincial Nominee</MenuItem>
        ...
        <Grid item xs={12} sm={2}>
            ...
            >
                ...
                <MenuItem value="Vancouver British Columbia">Vancouver British Columbia</MenuItem>
        ...
        <Grid item xs={12} sm={5}>
            ...
            >
                ...
                <MenuItem value="Government Assistance">Government Assistance</MenuItem>
        ...
        <Grid item xs={12} sm={3}>
            ...
            variant="outlined"
            fullWidth
            InputProps={{ inputProps: { min: 1000, max: 50000, step: '0.01' } }}
            />
        </Grid>
        <Grid item xs={12} sm={3}>
            <FormControl fullWidth>
        ...
        <Grid item xs={12} sm={3}>
            <FormControlLabel
            control={<Checkbox checked={formData.hasACar} onChange={handleChange} name="hasACar" />}
            label="Has a Car"
            />
        </Grid>
        <Grid item xs={12} sm={6}>
